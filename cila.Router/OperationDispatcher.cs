...
namespace cila.Router
{
    public class OperationDispatcher
    {
        ...
        public OperationDispatcher(RouterProvider provider, ChainClientsFactory clientsFactory, ExecutionsService executionsService, KafkaProducer producer, CilaSettings settings, AggregagtedEventsService aggregagtedEventsService, ExecutionChainEventService executionChainEventService)
        {
